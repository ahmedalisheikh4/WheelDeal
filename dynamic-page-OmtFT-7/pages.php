...
<!-- Mirrored from product.geniusocean.com/carspace/dynamic-page-OmtFT-7/pages by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Oct 2023 13:57:56 GMT -->
								...
								<li class="nav-item">
									<a class="nav-link " href="../pages/cars.php">Cars</a>
										...
										<div class="dropdown-menu">
																							<a class="dropdown-item " href="pages.php">About Us</a>
																							...
																							<a class="dropdown-item active" href="../dynamic-page-OmtFT-7/pages.php">Dynamic Page</a>
																					</div>
									</li>
																								<li class="nav-item">
	...
	<!-- About Area Start -->
		<section class="about about-page">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<h3 class="title">Dynamic Page</h3>
						<p>
