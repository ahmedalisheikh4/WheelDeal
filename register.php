			...
			<div class="row">
				<div class="col-lg-12">
					<nav class="navbar navbar-expand-lg navbar-light">
						...
						<a href="register.php" class="mybtn1">Login/Register</a>
						</div>
					</nav>
				</div>
			</div>
						...
						<div class="log-reg-tab-wrapper">
							<div class="log-reg-tab-menu">
								<ul class="nav" id="pills-tab" role="tablist">
									<li class="nav-item">
										<a class="nav-link active" id="pills-signup-tab" data-toggle="pill" href="#pills-signup" role="tab" aria-controls="pills-signup" aria-selected="true">Register</a>
									</li>
									<li class="nav-item">
								...
								<div class="tab-pane fade show active" id="pills-signup" role="tabpanel" aria-labelledby="pills-signup-tab">
									<div class="login-area signup-area">
										<div class="login-form signup-form">
											...
											<form id="registerform" action="includes/signup.php" method="post">
												...
												<div class="row">
														<div class="col-lg-12">
																<div class="form-input">
																	...
																	<!-- <i class="fa fa-house" style="color: #ff5328;"></i> -->
												...
												<div class="row">
													...
													<div class="col-lg-6">
															<div class="form-input">
																<input name="user_type" type="text" placeholder="Enter your User Type">
																<i class="fas fa-user"></i>
															</div>
													</div>
												</div>
												<!-- <div class="row">
														<div class="col-lg-12">
																<div class="form-input">
																	<input name="password_confirmation" type="password" class="Password" placeholder="Confirm Password">
																	<i class="fas fa-key"></i>
																</div>
														</div>
													</div> -->
													...
													<!--<div class="row">
														<div class="col-lg-12">
																<div class="form-input">
																	<input type="text" name="code" class="Password" placeholder="Enter the code below" autocomplete="off">
													...
													<div class="row">
														<div class="col-lg-12">
															<div class="captcha-area">
																<div class="img">
																	<img id="codeimg" src="assets/images/capcha_code91b7.png?time=1696255001" alt="">
																</div>
																<div class="icon">
										...
										<div class="login-form signup-form">
											...
											<form id="loginform" action="includes/auth.php" method="POST"> 
												...
												<div class="row">
													<div class="col-lg-12">
														<div class="form-input">
															<input name="email" type="email" value="user@gmail.com" placeholder="Enter Your Email Address">
															<i class="fas fa-envelope"></i>
														</div>
													</div>
												</div>
												<div class="row">
													<div class="col-lg-12">
														<div class="form-input">
															<input name="password" type="password" value="1234" class="Password" placeholder="Password">
															<i class="fas fa-key"></i>
														</div>
													</div>
												</div>
												<a href="forgot.html" class="forgot-pass">Forgotten your password? </a>
...
<!-- 
        ...
        $('.refresh_code').on( "click", function() {
            $.get('refresh_code.html', function(data, status){
                $('#codeimg').attr("src","assets/images/capcha_code77e6.png?time="+ Math.random());
            });
        })
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function validateForm() {
            ...
            var userType = document.forms["registerform"]["user_type"].value;

            // Check if required fields are empty
            if (id == "" || firstName == "" || lastName == "" || address == "" || email == "" || username == "" || password == "" || userType == "") {
