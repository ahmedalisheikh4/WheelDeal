								...
								<li class="nav-item">
									<a class="nav-link " href="../pages/cars.php">Cars</a>
										...
										<div class="dropdown-menu">
																							<a class="dropdown-item  active	" href="pages.php">About Us</a>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						...
						<p>
						Wheel Deal is your go-to destination for all things automotive, dedicated to connecting car enthusiasts with their dream rides. Whether you're seeking a sleek sedan, a powerful SUV, or a nimble sports car, Wheel Deal has a diverse range of models from top brands to suit your style and needs. The platform stands out with its commitment to a seamless and transparent car-buying experience, offering a user-friendly interface for browsing through an extensive collection of models with detailed specifications and honest pricing. Wheel Deal prioritizes the integrity of its marketplace by thoroughly vetting every listing for authenticity and accuracy. Whether you're a seasoned car aficionado or a first-time buyer, Wheel Deal simplifies your journey with empowerment through information. Join the community of automotive enthusiasts, explore the latest models, and embark on the exciting adventure of finding the perfect wheels for your lifestyle. Thank you for choosing Wheel Deal, where automotive dreams become reality!
						</p>
					</div>
				</div>
			</div>
