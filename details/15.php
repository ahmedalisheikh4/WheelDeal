...
<!-- Mirrored from product.geniusocean.com/carspace/details/15 by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Oct 2023 13:58:04 GMT -->
			...
			<div class="row">
				<div class="col-lg-12">
					<nav class="navbar navbar-expand-lg navbar-light">
						<a class="navbar-brand" href="https://product.geniusocean.com/carspace">
						...
						<div class="collapse navbar-collapse fixed-height" id="main_menu">
							<ul class="navbar-nav ml-auto">
								<li class="nav-item">
									<a class="nav-link " href="https://product.geniusocean.com/carspace">Home</a>
								</li>
								<li class="nav-item">
									<a class="nav-link " href="../cars.html">Cars</a>
										...
										<div class="dropdown-menu">
																							<a class="dropdown-item " href="../about/pages.html">About Us</a>
																							<a class="dropdown-item " href="../privacy/pages.html">Privacy &amp; Policy</a>
																							<a class="dropdown-item " href="../termsu/pages.html">Terms &amp; Condition</a>
																							<a class="dropdown-item " href="../dynamic-page-OmtFT-7/pages.html">Dynamic Page</a>
																					</div>
									</li>
																								<li class="nav-item">
							...
							<a href="../register.html" class="mybtn1 ml-4">
																									Login/Register
															</a>
						</div>
					</nav>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						...
						<ul class="pages">
							<li>
								<a href="https://product.geniusocean.com/carspace">
									Home
								</a>
							</li>
							<li class="active">
				...
				<div class="col-lg-8">
					<div class="model-gallery-image">
						<div class="one-item-slider">
															<div class="item"><img src="../assets/front/images/cars/sliders/5d415f85be7de.html" alt=""></div>
															<div class="item"><img src="../assets/front/images/cars/sliders/5d415f85c0b36.html" alt=""></div>
															<div class="item"><img src="../assets/front/images/cars/sliders/5d415f85c2ff8.html" alt=""></div>
													</div>
						<ul class="all-item-slider">
															<li><img src="../assets/front/images/cars/sliders/5d415f85be7de.html" alt=""></li>
															<li><img src="../assets/front/images/cars/sliders/5d415f85c0b36.html" alt=""></li>
															<li><img src="../assets/front/images/cars/sliders/5d415f85c2ff8.html" alt=""></li>
													</ul>
					</div>
					<div class="profile-area">
						<div class="profile-info">
							<div class="left">
																	<img src="../assets/user/propics/1564396896.png" alt="" style="border-radius: 50%;">
															</div>
							<div class="right">
								<h4 class="title">
									Jackob Oram
								...
								<ul class="profile-meta">
									<li>
										<p>
											<i class="fas fa-map-marker-alt"></i> Dhanmondi, Dhaka
										</p>
									</li>
								</ul>
							</div>
							...
							<ul class="nav" role="tablist">
								<li class="nav-item">
									<a class="nav-link active" id="pills-productdetails-tab" data-toggle="pill" href="#pills-productdetails"
										role="tab" aria-controls="pills-productdetails" aria-selected="false">Product Details</a>
								</li>
								<li class="nav-item">
									<a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-contact" role="tab"
										aria-controls="pills-contact" aria-selected="false">Contact Info</a>
								</li>
							</ul>
						</div>
...
The 650S shares the MP4-12C&#039;s Carbon fiber reinforced polymer chassis, and is powered by the same McLaren M838T engine 3.8-litre V8, twin-turbo engine, but now developing 641 bhp (478 kW; 650 PS) and 500 lb·ft (680 N·m) of torque. Power is transmitted to the wheels through a seven-speed near instantaneous shift dual clutch gearbox.
					...
					<div class="latest-cars">
						...
						<ul class="cars-list">
									...
									<div class="landscape-single-car">
										<div class="img">
											<img src="../assets/front/images/cars/featured/5d3ec5b455555.jpg" alt="">
										</div>
										<div class="content">
											<a href="8.html" class="d-block">
											<h4 class="name">
									...
									<div class="landscape-single-car">
										<div class="img">
											<img src="../assets/front/images/cars/featured/5d3ec6cd8d581.jpg" alt="">
										</div>
										<div class="content">
											<a href="9.html" class="d-block">
											<h4 class="name">
									...
									<div class="landscape-single-car">
										<div class="img">
											<img src="../assets/front/images/cars/featured/6358fc21096e7.jpg" alt="">
										</div>
										<div class="content">
											<a href="15.html" class="d-block">
											<h4 class="name">
      ...
      <button type="button" class="close alert-close"><span>×</span></button>
            <ul class="text-left">
							...
							<div class="newsletter-form-area">
								<form id="geniusform" action="https://product.geniusocean.com/carspace/subscribe" method="post">
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
							<div class="content">
								<div class="content">
									<p><font color="#ffffff">Copyright © 2019. All Rights Reserved By </font><a href="https://geniusocean.com/" title="" target=""><font color="#ff6699">GeniusOcean.com</font></a></p>
							</div>
						</div>
					</div>
				</div>
	...
	var lat = ;
	var long = ;
	var address = "Dhanmondi, Dhaka";
	var mapicon = "../assets/front/images/map-marker.png";
</script>
...
<!-- Mirrored from product.geniusocean.com/carspace/details/15 by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Oct 2023 13:58:07 GMT -->
</html>
