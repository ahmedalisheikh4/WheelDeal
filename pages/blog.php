			...
			<div class="row">
				<div class="col-lg-8">
								...
								<div class="blog-images">
										<div class="img">
											<img src="assets/images/blogs/1560403187blog.jpg" class="img-fluid" alt="">
										</div>
                    ...
                    <a href='blog/25.html'>
                      <h4 class="blog-title">
                        Top Five secrets to become a model
								...
								<div class="blog-images">
										<div class="img">
											<img src="assets/images/blogs/1560403442blur-businesswoman-caucasian-941555.jpg" class="img-fluid" alt="">
										</div>
										<div class="date d-flex justify-content-center">
											<div class="box align-self-center">
												<p>02</p>
                    ...
                    <a href='blog/24.html'>
                      <h4 class="blog-title">
                        How to design effective arts?
								...
								<div class="blog-images">
										<div class="img">
											<img src="assets/images/blogs/1560403521afro-attractive-beautiful-2253065.jpg" class="img-fluid" alt="">
										</div>
										<div class="date d-flex justify-content-center">
											<div class="box align-self-center">
												<p>02</p>
                    ...
                    <li class="disabled"><span>&laquo;</span></li>
                                                                        ...
                                                                        <li class="active"><span>1</span></li>
                                                                                <li><a href="blog4658.php?page=2">2</a></li>
                                                                                <li><a href="blog9ba9.php?page=3">3</a></li>
                                                                                <li><a href="blogfdb0.php?page=4">4</a></li>
                                                                                <li><a href="blogaf4d.php?page=5">5</a></li>
                                                        
        
                    <li><a href="blog4658.php?page=2" rel="next">&raquo;</a></li>
            </ul>
...
<!-- Mirrored from product.geniusocean.com/carspace/blog by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Oct 2023 13:58:02 GMT -->
</html>
