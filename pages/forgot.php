...
<body>
	...
	<!-- About Area Start -->
		<section class="login-signup">
			<div class="container">
                ...
                <div class="forgot-header">
                  <h3 class="text-white">FOGOT PASSWORD</h3>
                </div>
      ...
      <button type="button" class="close alert-close"><span>×</span></button>
      	<p class="text-left"></p> 
      </div>											<form id="forgotform" action="https://product.geniusocean.com/carspace/forgot" method="POST">
...
<!-- Mirrored from product.geniusocean.com/carspace/forgot by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Oct 2023 13:58:36 GMT -->
</html>
